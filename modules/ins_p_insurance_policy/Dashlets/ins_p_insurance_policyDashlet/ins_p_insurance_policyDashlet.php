...
require_once('modules/ins_p_insurance_policy/ins_p_insurance_policy.php');

class ins_p_insurance_policyDashlet extends DashletGeneric { 
    function ins_p_insurance_policyDashlet($id, $def = null) {
        ...
        if(empty($def['title'])) $this->title = translate('LBL_HOMEPAGE_TITLE', 'ins_p_insurance_policy');
